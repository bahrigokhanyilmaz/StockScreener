...
const METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  },
  {
    ...
    name: 'Revenue Growth — Trailing (Rev ←)',
    shortName: 'Rev ← (trailing)',
    definition: 'How much the company\'s top-line sales grew compared to last year, from actual filings. Backward-looking. Shown for context only — it is NOT a screening filter.',
    formula: '(Current TTM Revenue - Prior TTM Revenue) / Prior TTM Revenue',
    threshold: 'Not filtered (display only)',
    ...
    decreasing: 'Demand slowed last year. Could signal market saturation, competitive losses, or macro headwinds. We now screen on forward revenue growth instead.',
    category: 'growth',
  },
  {
    key: 'est_lt_revenue_growth',
    name: 'Revenue Growth — Forward (Rev →)',
    shortName: 'Rev → (forward)',
    definition: 'Analyst consensus estimate of the company\'s revenue (top-line) growth rate over the next 1-3 years. Forward-looking. This is our hard revenue filter: a company must be expected to keep growing sales.',
    formula: 'Forward revenue CAGR from analyst estimates (nearest → furthest year)',
    threshold: '> 0% (hard filter — missing = FAIL)',
    increasing: 'Analysts expect sales to keep expanding. Sustainable top-line growth underpins long-term value creation.',
    decreasing: 'Analysts expect sales to shrink. A company projected to lose revenue is excluded regardless of current profitability.',
    category: 'growth',
  },
  {
    key: 'est_lt_growth',
    name: 'Estimated Long-Term EPS (Earnings) Growth — Forward (EPS Gr →)',
    shortName: 'EPS Gr → (forward)',
    definition: 'Analyst consensus estimate of the company\'s EARNINGS (EPS) growth rate over the next 1-3 years. Forward-looking. Distinct from revenue growth — earnings can be temporarily negative while a company invests, even as revenue grows.',
    formula: 'Analyst consensus forward EPS growth CAGR',
    threshold: '> 0% (soft — applied if data available)',
    increasing: 'Analysts becoming more optimistic about future earnings. Positive revisions often precede stock price gains.',
    decreasing: 'Analysts cutting earnings forecasts. Negative revisions signal deteriorating business outlook — but may also reflect heavy reinvestment while revenue still grows.',
    category: 'growth',
  },
  {
  ...
  },
  {
    ...
    shortName: 'Comp',
    definition: 'Competitive landscape rating from 1 (dominant/near-monopoly) to 5 (highly competitive/fragmented). Combines quantitative HHI analysis from SEC revenue data with Claude AI adjustment for niche positioning, moat strength, recent competitive dynamics, and AI disruption threat (how easily the company\'s offerings can be replicated or replaced by others using AI).',
    formula: 'Base: HHI from SEC SIC industry revenue concentration → mapped to 1-5. Adjusted by Claude considering moat, switching costs, brand, network effects, recent news, and AI disruptability (easily-replicable software/content/routine services push toward commoditization; proprietary data, regulatory barriers, physical assets, and network effects are AI-resilient).',
